...
This is a sample page to demonstrate:

* how 2nd-level navigation (above) is rendered in the [docSkimmer theme](https://github.com/hfagerlund/mkdocs-docskimmer/);
* how various Markdown syntax (below) is rendered in the [docSkimmer theme](https://github.com/hfagerlund/mkdocs-docskimmer/).
